...
class Database
{
    ...
    private function __construct() {
        if ($this->connection === null) {
            $this->connection = new PDO('mysql:dbname='.ConfigOld::get('DB_NAME').';host='.ConfigOld::get('DB_HOST').';charset='.ConfigOld::get('DB_CHARSET'), ConfigurationOld::get('DB_USER'), ConfigurationOld::get('DB_PASS'));
